...
class FrankaDataset(Dataset):
    ...
    def _prepare_data(self):
        ...
        for file_path in files:
            ...
            for i in range(self.step_size, N - (self.sequence_length * actual_step) - self.step_size + 1 - actual_step*2, 1):
                ...
                for j in range(self.sequence_length):
                    ...
                    low_dim_obs_current = np.concatenate([current_position, current_quat, [current_width]], axis=0)
                ...
                for j in range(self.sequence_length):
                    ...
                    future_width = actions[future_index+actual_step*2][-1]
